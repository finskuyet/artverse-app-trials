...
export default function SellerTutorialGuide({ 
  ...
  const baseTourSteps = [
    ...
    },
    {
      ...
      tooltip: "Atur Metode Pembayaran"
    },
    {
      ...
      tooltip: "Buka Kembali Tour"
    }
  ];

  const tourSteps = baseTourSteps;
  ...
  const handleNext = () => {
    if (currentStep < tourSteps.length - 1) {
      ...
      localStorage.setItem("finszart_tutorial_completed", "true");
      onClose();
    }
  };
